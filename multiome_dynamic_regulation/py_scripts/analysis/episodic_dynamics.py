...
class episode_dynamics:
    ...
    """
    def __init__(self, dictys_dynamic_object, output_folder, latent_factor_folder, trajectory_range=(1, 3), num_points=40, dist=0.001, sparsity=0.01, n_processes=16):
        """
...
class episode_composition:
    ...
    """
    def __init__(self, dictys_dynamic_object, output_folder, latent_factor_folder, trajectory_range=(1, 3), num_points=40, dist=0.001, sparsity=0.01, time_slice_start=0, time_slice_end=5):
        self.dictys_dynamic_object = dictys_dynamic_object
        self.output_folder = output_folder
        self.latent_factor_folder = latent_factor_folder
        self.trajectory_range = trajectory_range
